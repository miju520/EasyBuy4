    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          $(document).ready(function(){
                   $.getJSON("AjaxAddCarSevlet","id="+735,function(rs){
                   var str="";
                   for(var i=0; i<rs.length; i++){
                       str+='<tr>'
                            +'<td>'
            	            +'<div class="c_s_img"><img src="<%=path%>+'rs[i].fileName'" width="73" height="73" /></div>'
                            +'rs[i].name'
                            +'</td>'
                            ...
                            +'</div>'
                            +'</td>'
                            +'<td align="center" style="color:#ff4e00;">'+rs[i].price+'</td>'
                            +'<td align="center">26R</td>'
                            +'<td align="center"><a href="#">删除</a>&nbsp; &nbsp;<a href="#">加入收藏</a></td>'
                            +'</tr>';
          
                   };
                   $("[class=content mar_20]").html(str);
              });
